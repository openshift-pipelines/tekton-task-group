...
func (in *TaskGroupRunStatus) DeepCopyInto(out *TaskGroupRunStatus) {
	*out = *in
	...
	if in.TaskRuns != nil {
		...
		*out = make(map[string]*TaskGroupTaskRunStatus, len(*in))
		for key, val := range *in {
			var outVal *TaskGroupTaskRunStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(TaskGroupTaskRunStatus)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskGroupTaskRunStatus) DeepCopyInto(out *TaskGroupTaskRunStatus) {
	*out = *in
	if in.Status != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskGroupTaskRunStatus.
func (in *TaskGroupTaskRunStatus) DeepCopy() *TaskGroupTaskRunStatus {
	if in == nil {
		return nil
	}
	out := new(TaskGroupTaskRunStatus)
